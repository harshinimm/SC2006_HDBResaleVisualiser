...
# Allow requests from React frontend (running on http://localhost:3000)
...
EMAIL_HOST_PASSWORD = 'qfge zejm qesc rdlb'  # Use an App Password, not your actual password
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER

AUTH_USER_MODEL = 'account.User'  # Adjust the app name if necessary
